<script setup lang="ts">
    useSeoMeta({
        title: 'JBMC',
        ogTitle: 'JBMC',
        description: 'JBMC a forward-thinking technology company dedicated to providing innovative and customized solutions to meet the diverse needs of our clients. ',
        ogDescription: 'JBMC a forward-thinking technology company dedicated to providing innovative and customized solutions to meet the diverse needs of our clients. ',
        ogImage: '/logo.png',
    })
</script>
    ...
    <section class="pb-40 py-48 bg-gradient-to-br from-blue-50 via-pink-50 to-red-50 backdrop-blur-md">
        <div class="container text-center">
            ...
            <div class="flex flex-wrap justify-center mt-8 gap-4 animate__animated animate__fadeInUp">
                ...
                <a href="tel:0999170757" class="button-secondary max-sm:w-full">
                    Book a meeting
                </a>
            </div>
        </div>
