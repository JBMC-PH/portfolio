    ...
    <section class="py-24">
        <div class="container">
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2" data-aos="fade-up">
                ...
                <div class="p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6 relative">
                    <span class="inline-block text-orange-500 dark:text-blue-400">
                        <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 24 24"><path d="M15.75 2A2.25 2.25 0 0 1 18 4.25v15.5A2.25 2.25 0 0 1 15.75 22h-7.5A2.25 2.25 0 0 1 6 19.75V4.25A2.25 2.25 0 0 1 8.25 2h7.5zm0 1.5h-7.5a.75.75 0 0 0-.75.75v15.5c0 .414.336.75.75.75h7.5a.75.75 0 0 0 .75-.75V4.25a.75.75 0 0 0-.75-.75zm-2.501 14a.75.75 0 0 1 .002 1.5l-2.5.004a.75.75 0 0 1-.002-1.5l2.5-.004z" fill="currentColor" fill-rule="nonzero"/></svg>
                    </span>
                ...
                <div class="p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6 relative">
                    <span class="inline-block text-orange-500 dark:text-blue-400">
                        <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 24 24"><path fill="currentColor" d="M3 6.25A3.25 3.25 0 0 1 6.25 3h11.5A3.25 3.25 0 0 1 21 6.25v11.5A3.25 3.25 0 0 1 17.75 21H6.25A3.25 3.25 0 0 1 3 17.75V6.25ZM6.25 4.5A1.75 1.75 0 0 0 4.5 6.25v11.5c0 .966.784 1.75 1.75 1.75h7.25v-15H6.25Zm11.5 15a1.75 1.75 0 0 0 1.75-1.75V16H15v3.5h2.75Zm1.75-5v-5H15v5h4.5Zm0-6.5V6.25a1.75 1.75 0 0 0-1.75-1.75H15V8h4.5ZM6 13.75a.75.75 0 0 1 .75-.75h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1-.75-.75ZM7.25 6.5C6.56 6.5 6 7.06 6 7.75v2.5c0 .69.56 1.25 1.25 1.25h3.5c.69 0 1.25-.56 1.25-1.25v-2.5c0-.69-.56-1.25-1.25-1.25h-3.5ZM7.5 10V8h3v2h-3ZM6 16.75a.75.75 0 0 1 .75-.75h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1-.75-.75Z"/></svg>
                    </span>
